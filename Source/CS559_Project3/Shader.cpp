...
Shader::Shader()
{
	...
	this->light_position_handle = BAD_GL_VALUE;

	this->texture_handle = BAD_GL_VALUE;
}
...
void Shader::CommonSetup(
	...
	glUniform3fv(this->ka_handle, 1, ka);
	glUniform3fv(this->kd_handle, 1, kd);
	glUniform3fv(this->ks_handle, 1, ks);
	glUniform1f(this->shininess_handle, shiniess);
	glUniform3fv(this->la_handle, 1, la);
	glUniform3fv(this->ld_handle, 1, ld);
	glUniform3fv(this->ls_handle, 1, ls);
	glUniform3fv(this->light_position_handle, 1, light_position);
	glUniform1i(this->with_texture_handle, with_texture);
	//glEnable(GL_TEXTURE_2D);
	TextureManager::Inst()->BindTexture(text_id);
	//glBindTexture(GL_TEXTURE_2D,text_id);
	glUniform1i(this->with_attenuation_handle, with_attenuation);
...
bool Shader::Initialize(char * vertex_shader_file, char * fragment_shader_file)
{
	...
	this->ka_handle = glGetUniformLocation(this->program_id, (const GLchar *) "Ka");
	this->kd_handle = glGetUniformLocation(this->program_id, (const GLchar *) "Kd");
	this->ks_handle = glGetUniformLocation(this->program_id, (const GLchar *) "Ks");
	this->shininess_handle = glGetUniformLocation(this->program_id, (const GLchar *) "shine");

	this->la_handle = glGetUniformLocation(this->program_id, (const GLchar *) "La");
	this->ld_handle = glGetUniformLocation(this->program_id, (const GLchar *) "Ld");
	this->ls_handle = glGetUniformLocation(this->program_id, (const GLchar *) "Ls");
	this->light_position_handle = glGetUniformLocation(this->program_id, (const GLchar *) "Lp");

	this->texture_handle = glGetUniformLocation(this->program_id, (const GLchar *) "texture");
	this->with_texture_handle = glGetUniformLocation(this->program_id, (const GLchar *) "with_texture");
	this->with_attenuation_handle = glGetUniformLocation(this->program_id, (const GLchar*) "with_attenuation");
	this->cube_texture_handle = glGetUniformLocation(this->program_id, (const GLchar *) "cubemap");
